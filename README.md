...
<name> types <version>            # TypeScript declarations from the vendored schema
...
`types` writes `schema/<version>/schema.d.ts` for the four specifications that publish a JSON Schema — 26 versions, from 16 types for Arazzo 1.0 to 181 for MCP. See [utils/types](utils/types/types.md) for why a meta-schema needs handling a data schema does not.
