 ...
 */
export type Parameters = ParameterOrReference[];
 ...
 */
export type MediaType = Examples & SpecificationExtensions;
/**
 * This interface was referenced by `undefined`'s JSON-Schema
...
/**
 * This interface was referenced by `undefined`'s JSON-Schema
 * via the `definition` "media-type-or-reference".
 */
export interface MediaTypeOrReference {
  [k: string]: unknown;
}
/**
 * This interface was referenced by `undefined`'s JSON-Schema
