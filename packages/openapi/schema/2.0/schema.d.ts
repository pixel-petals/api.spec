...
export type NonBodyParameter =
  HeaderParameterSubSchema | FormDataParameterSubSchema | QueryParameterSubSchema | PathParameterSubSchema;
/**
 * This interface was referenced by `OpenApi`'s JSON-Schema
 ...
 */
export type Maximum = unknown;
/**
 * This interface was referenced by `OpenApi`'s JSON-Schema
 * via the `definition` "exclusiveMaximum".
 */
export type ExclusiveMaximum = unknown;
/**
 * This interface was referenced by `OpenApi`'s JSON-Schema
 * via the `definition` "minimum".
 */
export type Minimum = unknown;
/**
 * This interface was referenced by `OpenApi`'s JSON-Schema
 * via the `definition` "exclusiveMinimum".
 */
export type ExclusiveMinimum = unknown;
/**
 * This interface was referenced by `OpenApi`'s JSON-Schema
 ...
 */
export type UniqueItems = unknown;
/**
 * This interface was referenced by `OpenApi`'s JSON-Schema
 ...
 */
export type MultipleOf = unknown;
/**
 * This interface was referenced by `OpenApi`'s JSON-Schema
 ...
 */
export type Description = unknown;
